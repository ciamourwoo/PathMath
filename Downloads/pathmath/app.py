...
soal_bank = {
    "Pecahan": {
        ...
        3: ("Rina punya 3/4 liter sirup, Andi punya 2/3 liter. Siapa lebih banyak? Rina atau Andi?", "Rina" or "rina", "Hmm... penyebutnya beda, yuk samakan dulu! Ubah ke penyebut 12. 3/4 = 9/12, 2/3 = 8/12 → Siapa yang lebih banyak?")
    },
    "Pola Bilangan": {
